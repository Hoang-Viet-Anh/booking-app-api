    ...
    public static void SeedData(BookingContext context)
    {
        ...
        var coworkingsToSeed = new List<CoworkingModel>
        {
            new()
            {
                ...
                ImageUrls = new()
                {
                    "https://s3.magicman.cc/crocondine-booking-app/coworking/coworking-1.jpg"
                },
            ...
            new()
            {
                ...
                ImageUrls = new()
                {
                    "https://s3.magicman.cc/crocondine-booking-app/coworking/coworking-2.jpg"
                },
                WorkspacesCapacity = new List<WorkspaceCapacity>([
                    new()
                    {
            ...
            new()
            {
                ...
                ImageUrls = new()
                {
                    "https://s3.magicman.cc/crocondine-booking-app/coworking/coworking-3.jpg"
                },
                WorkspacesCapacity = new List<WorkspaceCapacity>([
                    new()
                    {
            ...
            new()
            {
                ...
                ImageUrls = new()
                {
                    "https://s3.magicman.cc/crocondine-booking-app/coworking/coworking-4.jpg"
                },
                WorkspacesCapacity = new List<WorkspaceCapacity>([
                    new()
                    {
            ...
            new()
            {
                ...
                ImageUrls = new()
                {
                    "https://s3.magicman.cc/crocondine-booking-app/coworking/coworking-5.jpg"
                },
                WorkspacesCapacity = new List<WorkspaceCapacity>([
                    new()
                    {
